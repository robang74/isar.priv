...
ROOTFS_INSTALL_COMMAND:prepend = "rootfs_install_pkgs_update"
ROOTFS_FEATURES += "clean-package-cache clean-package-lists generate-manifest export-dpkg-status clean-log-files clean-debconf-cache"
